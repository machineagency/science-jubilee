...
; Config file for Pipette, Sonicator, and Spectroscopy
...
M906 Z{0.70*sqrt(2)*1680}  ; 70% of 1680mA RMS current.
...
M569 P1.2 S0 			  ; Pipette Motor direction
M906 V{0.90*500} 		          ; 500mA peak current for gen2 pipette
...
M201 V800	           ; V (Pipette) Acceleration


M203 X18000 Y18000 Z1600 U9000 V10000  ; Maximum axis speeds [mm/min]
...
; ----------------------------------
M563 P2 S"Sonicator" 			 ; naming tool
